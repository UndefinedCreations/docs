...
<Tabs items={["Java", "Kotlin"]}>
    <Tab value="Java">
        ...
        The first parameter in the execution is a class that extends `CommandSender`, and the function will only be called if the cast is successful.
...
Now we need to add custom permissions to the command, using the [`addRequirement`](https://stellardocs.undefinedcreations.com/com/undefined/stellar/AbstractStellarCommand.html#addRequirement(java.lang.String)) method.

      ...
      '/stellar/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Understanding Command Context', link: '/stellar/getting-started/command-context' },
            { text: 'Understanding Command Tree', link: '/stellar/getting-started/command-tree' },
          ]
        },
        {
          text: 'Usage',
